    ...
    public void addBGLGraphClick(MenuItem item)
    {
        ...
        for(int i=0;i<measurements.size();i++)
        {
            ...
            if(measurements.get(i).getTitle().equals("Insulin"))
            {
                ...
                Prescription p = appMain.curPatient.findPrescription(obj.getPrescriptionID());
                String presc;
                if(p == null)
                {
                    presc="noNamePrescription";
                }
                else
                    presc=appMain.curPatient.findPrescription(obj.getPrescriptionID()).getName();
...
//
    ...
    public void editGoalsClick(MenuItem item)
    {
